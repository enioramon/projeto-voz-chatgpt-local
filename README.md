...
Projeto desenvolvido no Bootcamp Bradesco - GenAI & Dados (DIO)
Foco em integração de IA, processamento de áudio e automação
inteligente.
...
Este projeto implementa um assistente de voz local capaz de: - capturar
áudio do microfone, - converter fala em texto (Speech-to-Text), -
processar linguagem natural com IA, - gerar respostas inteligentes, -
converter texto em áudio (Text-to-Speech).
...
voz_chatgpt/ ├── app.py ├── recorder.py ├── whisper_stt.py ├──
chatgpt_api.py ├── tts.py ├── requirements.txt └── .env
...
Projeto criado como parte do portfólio prático do
Bootcamp Bradesco - GenAI & Dados | DIO, com foco em:
